    ...
    listPerfumes: [
...

      {
        ...
        notes: {
          ...
          middle: [
            { name: "Мята", src: green.mint },
            { name: "Металлический нероли", src: "" },
            { name: "Болгарская роза", src: "" },
            { name: "Аккорд гоночного трека", src: "" },
          ],
          base: [
